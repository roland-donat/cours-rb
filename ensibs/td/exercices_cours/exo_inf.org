...
1. Donner le nombre de paramètres pour définir la loi jointe représentée par le RB. 
1. Même question sans utiliser la factorisation de la loi jointe associée au RB. 
1. Reprendre les questions précédentes en calculant le nombre de paramètres probabilistes nécessaire
   à la définition de la loi jointe factorisée dans le RB et de la loi jointe naturelle des variables.
